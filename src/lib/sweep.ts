...
export async function buildSweepPlan({
  ...
  /** Sum of per-token quoted amountOut — the fee base (0.8% of full quotes). */
  ...
  // quotes, and 0.8% of quotes < 97% of quotes, so the fee transfer can never
  ...
  // quotedWldTotal is large enough that the 0.8% fee cannot round to zero.
